...
import './jsgif/LZWEncoder.exec';
import './jsgif/NeuQuant.exec';
import './jsgif/GIFEncoder.exec';
import './jsgif/b64.exec';
...
import creatingGifWarning from '../images/creating_gif_wait.png';
import deleteFrameImage from '../images/delete_frame.png';
...
function createNewFrame() {
  ...
  newFrame.innerHTML = `<img class="frame frame-${num}" width=96 height=96><button class="frames__delete-frame-button"><img class="frames__delete-frame-image" src=${deleteFrameImage} alt="delete frame button"></button>`;
...
refreshButton.addEventListener('click', () => {
  //finalGif.src = './images/creating_gif_wait.png';
  finalGif.src = creatingGifWarning;
  setTimeout(() => {
    createGif();
  }, 100);
});
